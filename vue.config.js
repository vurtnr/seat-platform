...
const name = 'Seat Platform' // TODO: get this variable from setting.ts

module.exports = {
  publicPath: process.env.NODE_ENV === 'production' ? '/seat-platform/' : '/',
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        ...
        target: 'http://t1.teranovo.cn:9020',
